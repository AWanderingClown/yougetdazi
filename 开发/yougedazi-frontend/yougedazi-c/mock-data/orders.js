...
module.exports = {
  orders: [
    // ========== 待支付状态 ==========
    {
      ...
      created_at: getNow() - 1 * ONE_MINUTE,
    ...
    },
    {
      ...
      created_at: getNow() - 5 * ONE_MINUTE,
    ...
    // 超过15分钟待支付（模拟自动取消）
    {
      ...
      created_at: getNow() - 20 * ONE_MINUTE,
    ...
    // 服务10分钟（≤15分钟可取消）
    {
      ...
      status: 'serving',
      total_price: 20000, // 200元
      created_at: getNow() - ONE_HOUR,
      order_no: 'PP202603290009',
      duration: 2,
      companion_id: 'c3',
      companion_name: '娜娜',
      companion_avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=200',
      service_start_time: getNow() - 10 * ONE_MINUTE, // 服务开始10分钟
      appointment_date: '今天',
    ...
    // 服务20分钟（>15分钟不可取消，显示续费）
    {
      ...
      status: 'serving',
      total_price: 10000, // 100元
      created_at: getNow() - 2 * ONE_HOUR,
      order_no: 'PP202603290010',
      duration: 1,
      companion_id: 'c2',
      companion_name: '阿杰',
      companion_avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200',
      service_start_time: getNow() - 20 * ONE_MINUTE, // 服务开始20分钟
      appointment_date: '今天',
    ...
    // 5小时前完成（可评价）
    {
      ...
      status: 'completed',
      total_price: 12000, // 120元
      created_at: getNow() - ONE_DAY,
      order_no: 'PP202603290011',
      duration: 2,
      companion_id: 'c1',
      companion_name: '小雨',
      companion_avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200',
      completedAt: new Date(getNow() - 5 * ONE_HOUR).toISOString(), // 5小时前完成
      hasReviewed: false,
      appointment_date: '昨天',
      appointment_time: '14:00'
    },
    ...
    // 已评价
    {
      ...
      companion_name: '可可',
      companion_avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=200',
      completedAt: new Date(getNow() - 8 * ONE_HOUR).toISOString(),
      hasReviewed: true,
      appointment_date: '昨天',
    ...
    // 用户主动取消
    {
      ...
      status: 'cancelled',
      total_price: 15000, // 150元
      created_at: getNow() - 3 * ONE_HOUR,
      order_no: 'PP202603290014',
      duration: 2,
      cancel_reason: '临时有事',
      cancelled_at: getNow() - 2 * ONE_HOUR,
      appointment_date: '今天',
    ...
    // 超时自动取消
    {
      ...
      duration: 4,
      cancel_reason: '超时未支付',
      cancelled_at: getNow() - 20 * ONE_HOUR,
      appointment_date: '昨天',
